...
aLangKeys['es']['trayectoria-2']='Al momento de crear Lexar, busqué colegas de esas profesiones que contaran con amplia experiencia y que, sobre todo, compartieran mis mismos valores. De ese modo, se creó un excelente equipo de trabajo coordinado por mí que es el alma de Lexar.';
...
aLangKeys['es']['forma-de-trabajo-2']='En Lexar, consideramos que el diálogo fluido con el cliente, las consultas y el trabajo conjunto es fundamental para entender cabalmente qué necesita, cuál es su objetivo, qué espera obtener y con qué tiempos cuenta para hacerlo. Solo de esa forma podremos brindar el conocimiento, las herramientas, la flexibilidad, la eficiencia y la calidad que merece. Juntos determinamos la necesidad de comunicación para poder crear la mejor solución ideada específicamente para él.';
...
aLangKeys['es']['servicios-interpretacion-consecutiva-2']='Lexar recomienda usar la interpretación consecutiva en conferencias telefónicas, conferencias de prensa, juicios, casamientos (ceremonia civil y religiosa), entrevistas, discursos, presentaciones, ponencias, negociaciones y reuniones de negocios, entre otras.';
...
aLangKeys['es']['especializaciones-it-4']='Programas informáticos (software);';
...
aLangKeys['es']['especializaciones-rrhh-12']='Curriculum vitae.';
...
aLangKeys['es']['guion-subtitulado']='Cantidad de palabras (guión escrito)';
...
aLangKeys['es']['sumate-cv']='Subir tu curriculum vitae';
...
aLangKeys['es']['dia']='Miércoles';
aLangKeys['es']['hora']='de 9.00 a 10.00';
